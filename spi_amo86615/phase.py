...
def phase(I, support, params, good_pix = None, sample_known = None):
    ...
    return x_g.get(), M, emod, None, support
...
if __name__ == "__main__":
    ...
    sample_ret, diff_ret, emod, efid, support_ret = phase(diff, support, params, \
                                good_pix = good_pix, sample_known = sample_known)
    
    # write the h5 file 
    io_utils.write_output_h5(params['output']['path'], diff, diff_ret, support, \
                    support_ret, good_pix, sample_known, sample_ret, emod, efid)
